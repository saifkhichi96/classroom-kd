...
parser.add_argument('--no_ask', action='store_true', default=False,
                    help='Knowledge distillation method. Default: disable')
parser.add_argument('--no_mentor', action='store_true', default=False,
                    help='Knowledge distillation method. Default: disable')   
parser.add_argument('--dtkd_mentor', action='store_true', default=False,
                    help='Knowledge distillation method. Default: disable')            
parser.add_argument('--ask_b', action='store_true', default=False,
                    help='Knowledge distillation method. Default: disable')
parser.add_argument('--kd', type=str, default='',
                    help='Knowledge distillation method. Default: disable')
#teachers
parser.add_argument('--student-pretrained', action='store_true',
                    help='load pretrained model of student')
parser.add_argument('--student-ckpt', type=str, default='',help='path to the ckpt of student model')
parser.add_argument('--teacher-model', type=str, nargs='+', default=[], help='teacher model name')
...
parser.add_argument('--teacher-ckpt', type=str, nargs='+', default=[], help='path to the ckpt of teacher model')
#peers
parser.add_argument('--peer-model', type=str, nargs='+', default=[], help='teacher model name')
parser.add_argument('--peer-pretrained', action='store_true',
                    help='load pretrained model of teacher')
parser.add_argument('--peer-no-pretrained', action='store_false', dest='teacher_pretrained')
parser.set_defaults(teacher_pretrained=True)
parser.add_argument('--peer-ckpt', type=str, nargs='+', default=[], help='path to the ckpt of teacher model')

parser.add_argument('--kd-loss-weight', type=float, default=1., 
                    help='weight of kd loss')
parser.add_argument('--peer-loss-weight', type=float, default=1., 
                    help='weight of kd loss')                   
...
parser.add_argument('--peer-module', type=str, default='',
                    help='name of the student module used in kd. Default (""): use the output of model.')
