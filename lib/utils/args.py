...
parser.add_argument(
    "--smoothing", default=0.1, type=float, help="Epsilon value of label smoothing"
)
...
parser.add_argument(
    "--sched", default="step", type=str, help='LR scheduler (default: "step"'
)
parser.add_argument(
    "--decay-epochs", type=float, default=3, help="epoch interval to decay LR"
)
parser.add_argument(
...
parser.add_argument(
    "--min-lr", type=float, default=1e-5, help="minimal learning rate (default: 1e-5)"
)
parser.add_argument(
    "--epochs", type=int, default=200, help="number of epochs to train (default: 2)"
)
parser.add_argument(
    "--warmup-epochs",
    type=int,
...
parser.add_argument("--decay-rate", "--dr", type=float, help="LR decay rate")
parser.add_argument(
    "--decay_by_epoch",
    action="store_true",
    default=False,
...
parser.add_argument(
    "--color-jitter", type=float, default=0.0, help="Color jitter factor (default: 0.)"
)
parser.add_argument(
    "--cutout-length",
    type=int,
...
parser.add_argument(
    "--reprob", type=float, default=0.0, help="Random erase prob (default: 0.)"
)
parser.add_argument(
...
parser.add_argument(
    "--drop-path-rate", type=float, default=0.0, help="Drop path rate, (default: 0.)"
)
parser.add_argument(
    "--drop-path-strategy",
    type=str,
...
parser.add_argument(
    "--dist-port", default="12345", type=str, help="port for distributed communication"
)
...
parser.add_argument(
    "--kd", type=str, default="", help="Knowledge distillation method. Default: disable"
)
# teachers
parser.add_argument(
    "--student-pretrained", action="store_true", help="load pretrained model of student"
)
parser.add_argument(
    "--teacher-model", type=str, nargs="+", default=[], help="teacher model name"
)
parser.add_argument(
    "--teacher-pretrained", action="store_true", help="load pretrained model of teacher"
)
parser.add_argument(
    "--teacher-no-pretrained", action="store_false", dest="teacher_pretrained"
)
...
# peers
parser.add_argument(
    "--peer-model", type=str, nargs="+", default=[], help="teacher model name"
)
parser.add_argument(
    "--peer-pretrained", action="store_true", help="load pretrained model of teacher"
)
parser.add_argument(
    "--peer-no-pretrained", action="store_false", dest="teacher_pretrained"
)
parser.set_defaults(teacher_pretrained=True)
parser.add_argument(
    "--peer-ckpt",
...
parser.add_argument(
    "--peer-loss-weight", type=float, default=1.0, help="weight of kd loss"
)
parser.add_argument(
...
# DBB
parser.add_argument("--dbb", action="store_true", default=False, help="Use DBB")

# DyRep
parser.add_argument("--dyrep", action="store_true", default=False, help="Use DyRep")
parser.add_argument(
    "--dyrep-adjust-interval",
    type=int,
    default=10,
    help="how many epochs to rep & dep the dyrep model",
)
parser.add_argument(
    "--dyrep-max-adjust-epochs",
    type=int,
    default=100,
    help="after how many epochs the dyrep model will be fixed.",
)
parser.add_argument(
    "--dyrep-recal-bn-iters",
    type=int,
    default=20,
    help="how many iterations for recalibrating the bn states in dyrep",
)
parser.add_argument(
    "--dyrep-recal-bn-every-epoch",
    action="store_true",
    default=False,
...
# EdgeNN
parser.add_argument(
    "--edgenn-config", type=str, default="", help="path to edgenn config"
)
